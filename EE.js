(function() {
	...
	var TableCode = "PA001"; //Table code TU131 / IA001
	...
	Url_Eurostat = "http://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/nama_10_gdp?"+Filters;
...
//		MetaData=JSONstat(response); //console.log(response.value, response.dimension, response.dimension.geo.category.index, response[dimension][geo]);
...
, error: function() {TableName = "mingi jama:"+error;}
});
...
if (resp.data[i].values[0] !== "." && resp.data[i].values[0] !== "..") {	
