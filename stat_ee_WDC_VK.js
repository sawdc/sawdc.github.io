(function() {
	...
	Url = "https://andmed.stat.ee/api/v1/et/statsql/"+ TableCode; //metadata url
	Url_eng = "https://andmed.stat.ee/api/v1/en/statsql/"+ TableCode;
...
if (MetaData_est.variables[i].code !== "Aasta" && MetaData_est.variables[i].code !== "Vaatlusperiood") {
	...
	CellsNo=CellsNo*(MetaData_est.variables[i].values.length - (Math.max(StartYear, MetaData_est.variables[i].values[0])-MetaData_est.variables[i].values[0].substring(0,4))*RefPerNo);
	DimAasta=i; 
	if (MetaData_est.variables[i].values.length - (Math.max(StartYear, MetaData_est.variables[i].values[0])-MetaData_est.variables[i].values[0].substring(0,4))*RefPerNo > Dim_max_length) {Dim_max=i; Dim_max_length=MetaData_est.variables[i].values.length - (Math.max(StartYear, MetaData_est.variables[i].values[0])-MetaData_est.variables[i].values[0].substring(0,4))*RefPerNo};
		};
	}
